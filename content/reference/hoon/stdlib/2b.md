...
[glossaryEntry."Convert wet gate to dry gate"]
...
[glossaryEntry."All indices in list"]
...
[glossaryEntry."First index in list"]
...
[glossaryEntry."Add separator between list elements"]
...
[glossaryEntry."Logical AND on list"]
...
[glossaryEntry."Logical OR on list"]
...
[glossaryEntry."Construct list from null-terminated tuple"]
...
[glossaryEntry."Remove from list"]
...
[glossaryEntry."Last item in list"]
...
[glossaryEntry."Prefix (produce front of list)"]
...
[glossaryEntry."Separate list into two lists from slammed elments"]
...
[glossaryEntry."Produce list of elements from boolean gate"]
...
[glossaryEntry."Produce list of elements failing boolean gate"]
...
[glossaryEntry."Produce all elements from index in list"]
...
[glossaryEntry."Produce element at specific index (list)"]
...
[glossaryEntry."Drop tail off list"]
...
[glossaryEntry."Append noun to list"]
...
[glossaryEntry."Gate to list (with state)"]
...
[glossaryEntry."Concatenate two lists"]
...
[glossaryEntry."Perfect concatenate (lists)"]
...
[glossaryEntry."Turn lists into single list by promoting elements from sublists"]
