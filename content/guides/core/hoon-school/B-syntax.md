...
Implement a version of the absolute value function, |𝑥|, similar to the Heaviside implementation above.  (Translate it to 10 as well since we still can't deal with negative numbers; call this |𝑥|~10~.)
